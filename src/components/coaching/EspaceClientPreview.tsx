      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {device === 'web' && (
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-10 lg:gap-14 items-center">
        ...
        {device === 'mobile' && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-8 lg:gap-12 max-w-4xl mx-auto">
            <PhoneBlock
