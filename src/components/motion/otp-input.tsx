  ...
  return (
    <div className={cn("inline-flex flex-col gap-2", className)}>
      ...
      >
        ...
        <div ref={slotsRef} className="flex items-center gap-1.5">
          {Array.from({ length }, (_, i) => {
            ...
            return (
              <div
                ...
                data-filled={char !== ""}
                className={cn(
                  "relative grid h-11 w-9 place-items-center overflow-hidden rounded-lg border text-base font-semibold tabular-nums transition-colors duration-200",
                  showSuccess
                    ? "border-hanami-500/60 text-foreground"
                    : status === "error"
        ...
        <AnimatePresence>
          {showSuccess ? (
            <motion.span
              ...
              className="pointer-events-none absolute -right-7 top-1/2 -translate-y-1/2 text-hanami-500"
              aria-hidden
            >
              <svg
                width="20"
