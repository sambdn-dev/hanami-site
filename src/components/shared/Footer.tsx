    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.footerGrid}>
          <div className={styles.footerBrand}><Link href="/" aria-label="Hanami — accueil"><Image src="/brand/2026/logo-principal-blanc.png" alt="Hanami Expert Gazon" width={120} height={43} /></Link><p>La décision juste. Le bon moment.<br />Un gazon qui dure.</p><span>Le Vésinet · Île-de-France<br />Coaching partout en France</span></div>
