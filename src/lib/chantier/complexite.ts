 ...
 *  - moyenne      : quelques arbres / massifs, contours légèrement courbes  ×1.15
 *  - elevee       : multiples arbres + massifs, formes courbes      ×1.30
 *  - tres_elevee  : pas japonais serrés, bordures découpées        ×1.50
 *
 * ACCÈS (logistique de livraison + allers-retours pendant le chantier)
 *  - facile     : entrée plain-pied, dépôt camion à proximité   ×1.00
 *  - moyen      : quelques marches, dépôt à <20 m              ×1.10
 *  - difficile  : escaliers, passage étroit, dépôt éloigné     ×1.25
 *
 * Effet cumulatif (multiplicatif). Exemples :
 *   - Simple + facile           → 1.00 × 1.00 = 1.00 (référence)
 *   - Moyenne + moyen           → 1.15 × 1.10 = 1.27 (+27 %)
 *   - Très élevée + difficile   → 1.50 × 1.25 = 1.88 (+88 %)
 */
