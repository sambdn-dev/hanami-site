...
export const SOLID_CATALOG: SolidCatalogProduct[] = [
  ...
  },
  {
    ...
    defaultUsageId: 'creation',
    usages: [
      { id: 'creation', label: 'Création (sol nu)', doseG_m2: 30, doseRange: '30–35 g/m²', note: 'Fiche Barenbrug : 15 kg = 500 m²' },
      { id: 'renovation', label: 'Rénovation / regarnissage', doseG_m2: 15, doseRange: '15–20 g/m²', note: 'Après scarif ou sursemis — fiche : 15 kg = 1000 m²' },
    ],
  ...
  // Semences Barenbrug grand public (Mon Gazon Passion / Facile)
  {
    ...
    defaultUsageId: 'creation',
    usages: [
      { id: 'creation', label: 'Création (sol nu)', doseG_m2: 25, doseRange: '25 g/m²' },
      { id: 'renovation', label: 'Rénovation / regarnissage', doseG_m2: 15, doseRange: '15 g/m²', note: 'Après scarif ou sursemis' },
    ],
  ...
  },
  {
    ...
    defaultUsageId: 'creation',
    usages: [
      { id: 'creation', label: 'Création (sol nu)', doseG_m2: 35, doseRange: '35 g/m²', note: 'Mélange enrichi en engrais — germe dès 10°C' },
      { id: 'renovation', label: 'Rénovation / regarnissage', doseG_m2: 20, doseRange: '20 g/m²', note: 'Après scarif ou sursemis' },
    ],
  ...
  },
  {
    ...
    defaultUsageId: 'reparation',
    usages: [
      { id: 'reparation', label: 'Réparation de zones / trous', doseG_m2: 40, doseRange: '35–40 g/m²', note: 'Produit prêt à l\'emploi en pansement sur zone dégradée — garder humide. Fiche : 3 kg = 80 m²' },
    ],
  ...
  },
  {
    ...
    usages: [
      { id: 'plantation', label: 'Plantation / semis', doseG_m2: 60, doseRange: '40–60 g/m²', note: 'Stimule l\'enracinement — catalogue Compo EV 2025' },
      { id: 'aeration', label: 'Aération / scarif', doseG_m2: 40, doseRange: '40–60 g/m²', note: 'Catalogue Compo EV 2025' },
    ],
